<template><div><h1 id="객체지향설계-ood" tabindex="-1"><a class="header-anchor" href="#객체지향설계-ood" aria-hidden="true">#</a> 객체지향설계(OOD)</h1>
...
<ul>
<li>
<p>tree형태로 구성, 부모 클래스 객체에 자식 객체를 담는다</p>
</li>
<li>
<p>polymorphic하게 구현</p>
</li>
</ul>
</li>
<li>
...
<ul>
<li>
<p>facade한 클래스 하나가 다른 클래스를 불러서 처리</p>
</li>
<li>
<p>효과 : 복잡한 framework가 드러나지 않는다</p>
</li>
</ul>
</li>
<li>
...
<ul>
<li>
<p>third party module과 client 사이에 proxy class를 만든다</p>
</li>
<li>
<p>third party module의 기능에 무언가를 추가하거나 수정 가능</p>
</li>
<li>
<p>third party module이 외부에 드러나지 않는다</p>
</li>
</ul>
</li>
</ul>
...
<h2 id="template" tabindex="-1"><a class="header-anchor" href="#template" aria-hidden="true">#</a> Template</h2>
<h3 id="template-function-overload-resolution" tabindex="-1"><a class="header-anchor" href="#template-function-overload-resolution" aria-hidden="true">#</a> Template function overload resolution</h3>
<ol>
<li>
<p>정확히 일치하는 함수</p>
</li>
...
<li>
<p>Standard type conversion</p>
</li>
<li>
<p>Implicit or user-defined type conversion</p>
</li>
<li>
<p>ERROR : ambiguous function calls</p>
</li>
</ol>
</li>
</ol>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span> <span class="token function">Max</span><span class="token punctuation">(</span><span class="token keyword">int</span> x<span class="token punctuation">,</span> <span class="token keyword">int</span> y<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>./a.out
existing one
7
generated one
7.2
...
<h3 id="wrap-around-for-overflow" tabindex="-1"><a class="header-anchor" href="#wrap-around-for-overflow" aria-hidden="true">#</a> Wrap around for overflow</h3>
...
<ol>
<li>
<p>function overloading : using compile time types of arguments</p>
</li>
<li>
<p>function overriding : using runtime types of receiver objects</p>
</li>
</ol>
...
<ol>
<li>
<p>함수가 virtual하게 정의되어 있어야 한다</p>
</li>
<li>
<p>receiver object가 포인터 또는 참조를 통해</p>
</li>
</ol>
</li>
</ul>
<h2 id="design-pattern-1" tabindex="-1"><a class="header-anchor" href="#design-pattern-1" aria-hidden="true">#</a> Design pattern</h2>
<ul>
<li>
<p>Singleton</p>
<p>자신의 객체와 생성자를 private member로 만든다</p>
</li>
<li>
<p>Builder</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">friend</span> HouseBuilder<span class="token punctuation">;</span>
...
<p>모든 공장들의 abstract한 interface 생성</p>
</li>
<li>
<p>Adapter</p>
<p>호환되지 않는 두 interface를 중간에서 연결</p>
</li>
<li>
<p>Bridge</p>
<p>Device 클래스와 Remote 클래스를 분리</p>
</li>
<li>
<p>Composite</p>
<p>자식들이 tree형태로 상속하는 구조</p>
</li>
<li>
<p>Facade</p>
<p>복잡한 내부 모듈 앞에 단순화된 하나의 Facade class 생성</p>
</li>
<li>
<p>Proxy</p>
<p>third-party모듈과 client사이를 연결</p>
<p>adapter는 third-party 객체를 멤버 변수로 소유</p>
</li>
</ul>
</div></template>
