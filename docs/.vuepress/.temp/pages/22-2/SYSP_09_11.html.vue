<template><div><h1 id="_221207-sysp" tabindex="-1"><a class="header-anchor" href="#_221207-sysp" aria-hidden="true">#</a> 221207 SYSP</h1>
<h2 id="목차" tabindex="-1"><a class="header-anchor" href="#목차" aria-hidden="true">#</a> 목차</h2>
<h3 id="_09-process-1" tabindex="-1"><a class="header-anchor" href="#_09-process-1" aria-hidden="true">#</a> <a href="#09-process1">09 - process 1</a></h3>
<h3 id="_10-process-2" tabindex="-1"><a class="header-anchor" href="#_10-process-2" aria-hidden="true">#</a> <a href="#10-process2">10 - process 2</a></h3>
<h3 id="_11-signal" tabindex="-1"><a class="header-anchor" href="#_11-signal" aria-hidden="true">#</a> <a href="#11-signal">11 - signal</a></h3>
<hr>
<h2 id="_09-process1" tabindex="-1"><a class="header-anchor" href="#_09-process1" aria-hidden="true">#</a> 09-process1</h2>
<h3 id="예외적인-제어-흐름" tabindex="-1"><a class="header-anchor" href="#예외적인-제어-흐름" aria-hidden="true">#</a> 예외적인 제어 흐름</h3>
<ul>
<li>하위 매커니즘
<ol>
<li>예외 (Exception)</li>
...
<h3 id="예외-테이블-exception-tables" tabindex="-1"><a class="header-anchor" href="#예외-테이블-exception-tables" aria-hidden="true">#</a> 예외 테이블 (Exception Tables)</h3>
<ul>
<li>각 이벤트 타입은 예외번호 k를 갖는다</li>
</ul>
<h3 id="비동기형-예외-interrupt" tabindex="-1"><a class="header-anchor" href="#비동기형-예외-interrupt" aria-hidden="true">#</a> 비동기형 예외 (Interrupt)</h3>
<ul>
<li>
<p>입출력 인터럽트 (ctrl + c)</p>
</li>
...
<li>
<p>소프트 리셋 인터럽트</p>
<h3 id="동기형-예외" tabindex="-1"><a class="header-anchor" href="#동기형-예외" aria-hidden="true">#</a> 동기형 예외</h3>
</li>
<li>
...
<h3 id="page-fault" tabindex="-1"><a class="header-anchor" href="#page-fault" aria-hidden="true">#</a> Page Fault</h3>
<ul>
<li>
...
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> a <span class="token punctuation">[</span><span class="token number">1000</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="process" tabindex="-1"><a class="header-anchor" href="#process" aria-hidden="true">#</a> Process</h3>
<blockquote>
...
<h3 id="multiprocessing-과거" tabindex="-1"><a class="header-anchor" href="#multiprocessing-과거" aria-hidden="true">#</a> Multiprocessing (과거)</h3>
<ol>
<li>
...
<h3 id="multiprocessing-현대" tabindex="-1"><a class="header-anchor" href="#multiprocessing-현대" aria-hidden="true">#</a> Multiprocessing (현대)</h3>
</li>
<li>
<p>멀티코어 프로세서</p>
</li>
...
<h3 id="동시성-프로세스" tabindex="-1"><a class="header-anchor" href="#동시성-프로세스" aria-hidden="true">#</a> 동시성 프로세스</h3>
<ol>
<li>두 프로세스의 실행시간이 서로 중첩되면 -&gt; <b>concurrent</b></li>
<li>중첩되지 않고 순차적으로 실행된다면 -&gt; <b>sequential</b></li>
</ol>
<h3 id="fork" tabindex="-1"><a class="header-anchor" href="#fork" aria-hidden="true">#</a> fork</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">fork</span><span class="token punctuation">(</span><span class="token keyword">void</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>호출하는 프로세스와 동일한 새 프로세스 생성</li>
<li>자식 프로세스는 0을 리턴</li>
<li>부모 프로세스는 자식 프로세스의 pid 리턴</li>
</ul>
<h3 id="exit" tabindex="-1"><a class="header-anchor" href="#exit" aria-hidden="true">#</a> exit</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">void</span> <span class="token function">exit</span><span class="token punctuation">(</span><span class="token keyword">int</span> status<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>종료 상태 status 값을 가지고 종료 (정상이면 0)</li>
<li>atexit() 함수는 exit 할 때 실행할 함수를 등록</li>
</ul>
<h3 id="좀비-zombies" tabindex="-1"><a class="header-anchor" href="#좀비-zombies" aria-hidden="true">#</a> 좀비 (Zombies)</h3>
<ul>
<li>
<p>종료되었지만, 아직 정리되지 않은 프로세스</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">void</span> <span class="token function">fork8</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h2 id="_10-process2" tabindex="-1"><a class="header-anchor" href="#_10-process2" aria-hidden="true">#</a> 10-process2</h2>
<h3 id="wait" tabindex="-1"><a class="header-anchor" href="#wait" aria-hidden="true">#</a> wait</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">wait</span> <span class="token punctuation">(</span><span class="token keyword">int</span> <span class="token operator">*</span>child_status<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="waitpid" tabindex="-1"><a class="header-anchor" href="#waitpid" aria-hidden="true">#</a> waitpid</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token function">waitpid</span><span class="token punctuation">(</span>pid<span class="token punctuation">,</span> <span class="token operator">&amp;</span>status<span class="token punctuation">,</span> options<span class="token punctuation">)</span>
...
<h3 id="sleep" tabindex="-1"><a class="header-anchor" href="#sleep" aria-hidden="true">#</a> sleep</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token comment">// 자기 자신을 secs초 동안 정지</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="execve" tabindex="-1"><a class="header-anchor" href="#execve" aria-hidden="true">#</a> execve</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">execve</span><span class="token punctuation">(</span><span class="token keyword">char</span> <span class="token operator">*</span>filename<span class="token punctuation">,</span> <span class="token keyword">char</span> <span class="token operator">*</span>argv<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token keyword">char</span> <span class="token operator">*</span>envp<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
...
<li>
<p>example</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token punctuation">(</span>pid <span class="token operator">=</span> <span class="token function">fork</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token operator">==</span> <span class="token number">0</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="shell" tabindex="-1"><a class="header-anchor" href="#shell" aria-hidden="true">#</a> shell</h3>
<blockquote>
...
<h3 id="eval" tabindex="-1"><a class="header-anchor" href="#eval" aria-hidden="true">#</a> eval</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">void</span> <span class="token function">eval</span><span class="token punctuation">(</span><span class="token keyword">char</span> <span class="token operator">*</span>cmdline<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>-&gt; 백그라운드 작업이 종료되면 zombie가 된다</p>
<ul>
<li>해결방법 : <strong>signal</strong></li>
</ul>
<h2 id="_11-signal-1" tabindex="-1"><a class="header-anchor" href="#_11-signal-1" aria-hidden="true">#</a> 11-signal</h2>
<h3 id="signal" tabindex="-1"><a class="header-anchor" href="#signal" aria-hidden="true">#</a> Signal</h3>
<blockquote>
<p>어떤 이벤트가 시스템에 발생했다는 것을 프로세스에게 알려주는 짧은 메시지</p>
</blockquote>
<h3 id="receiving-a-signal" tabindex="-1"><a class="header-anchor" href="#receiving-a-signal" aria-hidden="true">#</a> Receiving a signal</h3>
<blockquote>
...
<h3 id="시그널의-특징" tabindex="-1"><a class="header-anchor" href="#시그널의-특징" aria-hidden="true">#</a> 시그널의 특징</h3>
<ul>
...
<h3 id="프로세스-그룹" tabindex="-1"><a class="header-anchor" href="#프로세스-그룹" aria-hidden="true">#</a> 프로세스 그룹</h3>
<ul>
...
<h3 id="키보드로부터-시그널-보내기" tabindex="-1"><a class="header-anchor" href="#키보드로부터-시그널-보내기" aria-hidden="true">#</a> 키보드로부터 시그널 보내기</h3>
<ul>
...
<h3 id="시그널-받기" tabindex="-1"><a class="header-anchor" href="#시그널-받기" aria-hidden="true">#</a> 시그널 받기</h3>
<ul>
...
<h3 id="시그널-핸들러의-설치" tabindex="-1"><a class="header-anchor" href="#시그널-핸들러의-설치" aria-hidden="true">#</a> 시그널 핸들러의 설치</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token class-name">handler_t</span> <span class="token operator">*</span><span class="token function">signal</span><span class="token punctuation">(</span><span class="token keyword">int</span> signum<span class="token punctuation">,</span> <span class="token class-name">handler_t</span> <span class="token operator">*</span>handler<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>handler의 값
<ul>
...
<h3 id="시그널-블록하기와-해제하기" tabindex="-1"><a class="header-anchor" href="#시그널-블록하기와-해제하기" aria-hidden="true">#</a> 시그널 블록하기와 해제하기</h3>
<ul>
<li>
<p>sigprocmask 이용</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">sigprocmask</span><span class="token punctuation">(</span><span class="token keyword">int</span> how<span class="token punctuation">,</span> <span class="token keyword">const</span> <span class="token class-name">sigset_t</span> <span class="token operator">*</span>set<span class="token punctuation">,</span> <span class="token class-name">sigset_t</span> <span class="token operator">*</span>oldest<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
...
<h3 id="경주-race-현상으로-인한-동기화의-문제" tabindex="-1"><a class="header-anchor" href="#경주-race-현상으로-인한-동기화의-문제" aria-hidden="true">#</a> 경주 Race 현상으로 인한 동기화의 문제</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">void</span> <span class="token function">handler</span><span class="token punctuation">(</span><span class="token keyword">int</span> sig<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="경주현상을-회피하는-동기화-방법" tabindex="-1"><a class="header-anchor" href="#경주현상을-회피하는-동기화-방법" aria-hidden="true">#</a> 경주현상을 회피하는 동기화 방법</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token keyword">int</span> argc<span class="token punctuation">,</span> <span class="token keyword">char</span> <span class="token operator">*</span><span class="token operator">*</span>argv<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">int</span> pid<span class="token punctuation">;</span>
...
<h3 id="명시적으로-핸들러를-기다리는-방식" tabindex="-1"><a class="header-anchor" href="#명시적으로-핸들러를-기다리는-방식" aria-hidden="true">#</a> 명시적으로 핸들러를 기다리는 방식</h3>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">volatile</span> <span class="token class-name">sig_atomic_t</span> pid<span class="token punctuation">;</span> <span class="token comment">// pid는 전역변수로 선언</span>
...
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">sigsuspend</span><span class="token punctuation">(</span><span class="token keyword">const</span> <span class="token class-name">sigset_t</span> <span class="token operator">*</span>mask<span class="token punctuation">)</span><span class="token punctuation">;</span>
